"""Soluna-Gram module that contains utilities related to system status."""
...
from solgram import Config, pgm_version
from solgram.common.status import get_bot_uptime
from solgram.enums import Client, Message
from solgram.listener import listener
from solgram.utils import lang, execute
...
async def ping(client: Client, message: Message):
    """Calculates latency between Soluna-Gram and Telegram."""
    start = datetime.now()
