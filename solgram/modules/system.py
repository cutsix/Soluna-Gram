...
from solgram.common.system import run_eval, paste_pb
from solgram.enums import Message
from solgram.listener import listener
from solgram.utils import attach_log, execute, lang, upload_attachment
...
async def send_log(message: Message):
    """Send log to a chat."""
    if not exists("data/solgram.log"):
