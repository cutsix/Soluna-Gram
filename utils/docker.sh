...
SOLUNA_IMAGE_NAME="${SOLUNA_IMAGE_NAME:-soluna-gram:local}"
...
shon_online () {
    ...
    echo ""
    echo ""
    echo "欢迎使用 Soluna-Gram Docker 一键安装脚本。"
    echo
    echo "请选择您需要进行的操作:"
    echo "  1) Docker 安装 Soluna-Gram"
    echo "  2) Docker 卸载 Soluna-Gram"
    echo "  3) Docker 关闭 Soluna-Gram"
    echo "  4) Docker 启动 Soluna-Gram"
    echo "  5) Docker 重启 Soluna-Gram"
